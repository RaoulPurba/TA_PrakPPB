...
import SearchBar from "../components/searchbar.js"; // Ensure the correct path to your SearchBar component
    ...
    const fetchHero = async () => {
      try {
        ...
        if (response.status === 200) {
          ...
          setFilteredHeroes(response.data.hero); // Initialize filteredHeroes with all heroes
        }
      } catch (error) {
        console.log(error);
      }
